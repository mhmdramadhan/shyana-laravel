        ...
        <div class="card-body card-block">
            <form action="{{ route('transactions.update', $item->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') ? old('email') : $item->email }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="number" id="number" value="{{ old('number') ? old('number') : $item->number }}"
