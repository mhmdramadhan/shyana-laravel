        ...
        <div class="card-body card-block">
            <form action="{{ route('products.update', $item->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="type" id="type" value="{{ old('type') ? old('type') : $item->type }}"
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="quantity" id="quantity" value="{{ old('quantity') ? old('quantity') : $item->quantity }}"
